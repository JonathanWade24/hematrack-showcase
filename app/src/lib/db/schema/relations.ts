...
export const samplesInLaboratoryRelations = relations(samplesInLaboratory, ({one, many}) => ({
	...
	results_hplcInLaboratories: many(results_hplcInLaboratory),
}));
...
export const omics_subjectsInLaboratoryRelations = relations(omics_subjectsInLaboratory, ({many}) => ({
...
export const results_hplcInLaboratoryRelations = relations(results_hplcInLaboratory, ({one}) => ({
	samplesInLaboratory: one(samplesInLaboratory, {
		fields: [results_hplcInLaboratory.sample_id],
		references: [samplesInLaboratory.sample_id]
	}),
}));